    ...
    QString ProtocolInfoTag(Data.left(4));
        ...
        //end Messages
                ...
                qWarning()<<"File\t"<<__FILE__<<"\n"
                    <<"Line:\t"<<__LINE__<<"\n"
                    <<"Function:\t"<<"CProtocol::slotInputKnown"<<"\n"
                    <<"Message:\t"<<"Unknown ProtocolInfoTag: "<<ProtocolInfoTag<<"\n"<<"Packet ignored"<<"\n";
            }
}
        ...
        if(Data.contains("CHATSYSTEM\t")==true){
            ...
            if(OK==false){
                qCritical()<<"File\t"<<__FILE__<<"\n"
                       <<"Line:\t"<<__LINE__<<"\n"
                       <<"Function:\t"<<"CProtocol::slotInputUnknown"<<"\n"
...
void CProtocol::send(const COMMANDS_TAGS TAG,const qint32 ID)const
{
    ...
    switch(TAG){
        ...
        default:
        {
            qCritical()<<"File\t"<<__FILE__<<"\n"
                <<"Line:\t"<<__LINE__<<"\n"
                <<"Function:\t"<<"CProtocol::send"<<"\n"
                <<"Message:\t"<<"unhandeld Command-TAG"<<"exit"<<"\n";
            exit(-1);
        }
...
void CProtocol::send(const MESSAGES_TAGS TAG,const qint32 ID,QByteArray Data) const
{
    ...
    switch(TAG)
    {
        ...
        default:
        {
            qCritical()<<"File\t"<<__FILE__<<"\n"
                <<"Line:\t"<<__LINE__<<"\n"
                <<"Function:\t"<<"CProtocol::send"<<"\n"
                <<"Message:\t"<<"unhandeld Message-TAG"<<"exit"<<"\n";
    ...
    Data.insert(0,Paketlength.toUtf8());
    *(stream)<<Data;
}
