...
double CUser::getProtocolVersion_D() const
{
    ...
    if(OK==false){
        qCritical()<<"File\t"<<__FILE__<<"\n"
               <<"Line:\t"<<__LINE__<<"\n"
               <<"Function:\t"<<"CUser::getProtocolVersion_D"<<"\n"
...
double CUser::getMaxProtocolVersionFiletransfer_D() const
{
    ...
    if(OK==false){
        qCritical()<<"File\t"<<__FILE__<<"\n"
               <<"Line:\t"<<__LINE__<<"\n"
               <<"Function:\t"<<"CUser::getMaxProtocolVersionFiletransfer_D"<<"\n"
               <<"Message\t"<<"Can't convert QString to double"<<"\n"
...
double CUser::getMinProtocolVersionFiletransfer_D() const
{
    ...
    if(OK==false){
        qCritical()<<"File\t"<<__FILE__<<"\n"
               <<"Line:\t"<<__LINE__<<"\n"
               <<"Function:\t"<<"CUser::getMinProtocolVersionFiletransfer_D"<<"\n"
               <<"Message:\t"<<"Can't convert QString to double"<<"\n"
    ...
    switch (Tag){
        ...
        case AGE:
        {
            ...
            if(OK==false){
                qCritical()<<"File\t"<<__FILE__<<"\n"
                       <<"Line:\t"<<__LINE__<<"\n"
                       <<"Function:\t"<<"Can't convert QString to qint32"<<"\n"
                       <<"QString:\t"<<value<<"\n";
            }
            break;
        }
        ...
        default:
        {
            qWarning()<<"File\t"<<__FILE__<<"\n"
                  <<"Line:\t"<<__LINE__<<"\n"
                  <<"Function:\t"<<"CUser::setRecivedUserInfos"<<"\n"
                  <<"Message:\t"<<"unknown Tag"<<"\n";
            break;
        }
    }
...
void CUser::setRecivedNicknameToUserNickname()
{
    if(getProtocolVersion_D()>=0.3){
        ...
        qWarning()<<"File\t"<<__FILE__<<Qt::endl
              ...
              <<"Function:\t"<<"setRecivedNicknameToUserNickname"<<Qt::endl
              <<"Message:\t"<<"Protocolversion <0.3, action ignored"<<Qt::endl;
    }
}
...
void CUser::setReplaceB32WithB64(QString b64Dest)
{
    ...
    qCritical()<<"File\t"<<__FILE__<<Qt::endl
           <<"Line:\t"<<__LINE__<<Qt::endl
           <<"Function:\t"<<"CUser::setReplaceB32WithB64"<<Qt::endl
           <<"Message:\t"<<"Current Destination is not a b32 dest"<<Qt::endl;
    }
}
